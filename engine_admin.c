...
{   //IDD ver. 1.0.21
    ...
    else
    {
        ...
        result=cmeStrConstrAppend(&sqlQuery,"BEGIN TRANSACTION; "
                                    ...
                                    "CREATE INDEX idx_sto_uo ON storage(userId,orgId); "
                                    ...
                                    "CREATE INDEX idx_fwl_uo ON filterWhitelist(userId,orgId); "
                                    "CREATE TABLE filterBlacklist (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_fbl_uo ON filterBlacklist(userId,orgId); "
                                    "COMMIT;");
    ...
    else
    {
        ...
        result=cmeStrConstrAppend(&sqlQuery,"BEGIN TRANSACTION; "
                                    ...
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rdoc_uo ON documents(userId,orgId);"
                                    "CREATE TABLE users (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rusr_uo ON users(userId,orgId);"
                                    "CREATE TABLE roleTables (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rtbl_uo ON roleTables(userId,orgId);"
                                    "CREATE TABLE parserScripts (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rscr_uo ON parserScripts(userId,orgId);"
                                    "CREATE TABLE outputDocuments (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rodoc_uo ON outputDocuments(userId,orgId);"
                                    "CREATE TABLE content (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rcnt_uo ON content(userId,orgId);"
                                    "CREATE TABLE contentRows (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rcrow_uo ON contentRows(userId,orgId);"
                                    "CREATE TABLE contentColumns (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rccol_uo ON contentColumns(userId,orgId);"
                                    "CREATE TABLE dbNames (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rdbn_uo ON dbNames(userId,orgId);"
                                    "CREATE TABLE dbTables (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rdbt_uo ON dbTables(userId,orgId);"
                                    "CREATE TABLE tableRows (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rtrw_uo ON tableRows(userId,orgId);"
                                    "CREATE TABLE tableColumns (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rtcl_uo ON tableColumns(userId,orgId);"
                                    "CREATE TABLE organizations (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rorg_uo ON organizations(userId,orgId);"
                                    "CREATE TABLE storage (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rsto_uo ON storage(userId,orgId);"
                                    "CREATE TABLE documentTypes (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rdtyp_uo ON documentTypes(userId,orgId);"
                                    "CREATE TABLE engineCommands (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_recmd_uo ON engineCommands(userId,orgId);"
                                    "CREATE TABLE transactions (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rtrn_uo ON transactions(userId,orgId);"
                                    "CREATE TABLE meta (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rmta_uo ON meta(userId,orgId);"
                                    "CREATE TABLE filterWhitelist (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rfwl_uo ON filterWhitelist(userId,orgId);"
                                    "CREATE TABLE filterBlacklist (id INTEGER PRIMARY KEY,"
                                    " userId TEXT, orgId TEXT, salt TEXT,"
                                    " _get TEXT, _post TEXT, _put TEXT, _delete TEXT,"
                                    " _head TEXT, _options TEXT, userResourceId TEXT, orgResourceId TEXT);"
                                    "CREATE INDEX idx_rfbl_uo ON filterBlacklist(userId,orgId);"
                                    "COMMIT;");
        if (result) //If error then exit.
        {
            cmeSetupEngineAdminDBsFree();
