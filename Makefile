...
am__objects_1 = config.$(OBJEXT) crypto.$(OBJEXT) db.$(OBJEXT) \
	engine_admin.$(OBJEXT) engine_interface.$(OBJEXT) \
	filehandling.$(OBJEXT) function_tests.$(OBJEXT) \
	perl_interpreter.$(OBJEXT) runtime.$(OBJEXT) \
	strhandling.$(OBJEXT) webservice_interface.$(OBJEXT) \
	xs_init.$(OBJEXT)
am_CaumeDSE_OBJECTS = main.$(OBJEXT) $(am__objects_1)
...
am__depfiles_remade = ./$(DEPDIR)/config.Po ./$(DEPDIR)/crypto.Po \
	./$(DEPDIR)/db.Po ./$(DEPDIR)/debug_tests.Po \
	...
	./$(DEPDIR)/runtime.Po ./$(DEPDIR)/strhandling.Po \
...
EXTRA_DIST = TEST samples README-alpha CHANGELOG.md README.md TUTORIAL.md API_EXAMPLES.md AI_USAGE.md HERRADURAKEX_AT_REST_PLAN.md openapi.yaml
all: config.h
...
uninstall-ipathbinPROGRAMS:
	...
	cd "$(DESTDIR)$(ipathbindir)" && $(am__rm_f) $$files

clean-ipathbinPROGRAMS:
	-$(am__rm_f) $(ipathbin_PROGRAMS)
